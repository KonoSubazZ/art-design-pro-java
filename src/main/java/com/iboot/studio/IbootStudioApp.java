...
@MapperScan("com.iboot.studio.infrastructure.persistence.mapper")
public class IbootStudioApp {

  public static void main(String[] args) {
    SpringApplication.run(IbootStudioApp.class, args);
  }
}
